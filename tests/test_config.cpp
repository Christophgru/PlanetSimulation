...
TEST(ScenarioConfigTest, RejectsUnboundedOrPhysicallyInvalidTerrainSettings) {
    ...
    raw["planets"][0]["terrain_lod"]["max_edge_segments"] = 33;
    EXPECT_THROW(parse(), std::invalid_argument);
    raw["planets"][0]["terrain_lod"]["max_edge_segments"] = 16;
    raw["planets"][0]["terrain_lod"]["steep_edge_segments"] = 33;
    EXPECT_THROW(parse(), std::invalid_argument);
    raw["planets"][0]["terrain_lod"]["steep_edge_segments"] = 24;
    raw["planets"][0]["terrain_lod"]["steep_slope_threshold"] = 0.0;
    EXPECT_THROW(parse(), std::invalid_argument);
    raw["planets"][0]["terrain_lod"]["steep_slope_threshold"] = 0.3;
...
TEST(ScenarioConfigTest, RejectsInvalidLandscapeZonesAndWater) {
    ...
    raw["planet"]["terrain_landscape"]["ridge_smoothing"] = 0.6;
    EXPECT_THROW(parse(), std::invalid_argument);
    raw["planet"]["terrain_landscape"]["ridge_smoothing"] = 0.15;
